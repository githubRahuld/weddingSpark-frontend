...
const AboutPage = () => {
  return (
    <div className="container mx-auto px-4 py-8 font-poppins bg-[url('/img/bg/list-bg.jpg')] bg-cover bg-center text-black">
      <h1 className="text-3xl font-bold mb-4 font-jost underline">About Us</h1>
      ...
      <div className="p-4 text-3xl font-caveat  font-bold text-justify">
        <p>
          This website helps local people book all wedding resources. We provide
          a platform where users can find various vendors for their wedding
          needs, including Venue, Attire Retailer, Caterer, Entertainment,
          Florist/Decorator, Wedding Planner/Coordinator, Baker, Transportation,
          Jeweler, and Designer. Users can easily browse through the available
          vendors and book them for their wedding events.
        </p>
